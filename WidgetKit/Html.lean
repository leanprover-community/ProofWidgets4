...
@[combinator_formatter Lean.Widget.Jsx.jsxText] def jsxText.formatter : Formatter := pure ()
@[combinator_parenthesizer Lean.Widget.Jsx.jsxText] def jsxText.parenthesizer : Parenthesizer := pure ()
